...
def generate_narrative(article: Article, API_KEY) -> StorySummary:
    ...
    prompt = (
        ...
        '\n'
        '요구 사항:\n'
        '1. 반드시 현실과 다른 **비유적 상황**으로 바꿔 **짧게 핵심만** 설명해주세요. (예: 회사, 마을, 학교, 동물 이야기 등)\n'
        '2. 기사에 등장하는 **실제 인물, 단체, 국가 이름**은 절대 그대로 사용하지 말고, 의미 있는 비유 표현으로 바꾸세요.**\n'
        '3. 영어 단어나 외래어를 쓰지 마세요. 모든 표현은 자연스러운 한국어로만 작성하세요.\n'
        '4. 사건의 긍정 또는 부정적인 흐름을 비유에서도 동일하게 유지하세요.\n'
        '5. 기사에 나오지 않은 **편향적인 비유는 하지 마세요**. (예: 지혜로운 어르신 : 정치인)\n'
        '6. 반드시 아래와 같은 JSON 형식으로만 출력하세요 (기타 문장, 설명, 개행 금지):\n'
        '```json\n'
        '[\n'
        '  {\n'
        '    "narrative": "<비유 본문 내용>",\n'
        ...
        ']\n'
        '```\n\n'
        '※ narrative는 한글로 된 비유 이야기이며, dictionary는 실제 개념과의 매핑이며, 중심 인물은 반드시 명확하게게 표현하세요. 또한 의미없는 비유 용어는 포함하지 마세요(예: "영정" : "영정", "꽃" : "헌화").\n\n'
        f'다음은 기사 내용입니다:\n{article.content}'
        )
